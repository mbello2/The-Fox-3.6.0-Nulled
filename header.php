...
<body <?php body_class( $body_class ); if($nav_type == 'nav_type_15' ||  $nav_type == 'nav_type_16' ||  $nav_type == 'nav_type_17' ||  $nav_type == 'nav_type_18') { echo 'id="header_sub_nav"'; }elseif ($nav_type == 'nav_type_19' ||  $nav_type == 'nav_type_19_f') { echo 'id="fixed_body_left"'; }?> >
<?php	
 if($rd_data['rd_loader'] == 'yes'){
